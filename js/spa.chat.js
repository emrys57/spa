...
spa.chat = (function () {
  ...
  onTapToggle = function ( event ){	 // eslint-disable-line no-unused-vars
  ...
  onSubmitMsg = function ( event ) {			 // eslint-disable-line no-unused-vars
  ...
  onListchange = function ( event ) {		 // eslint-disable-line no-unused-vars
    var
    list_html = String(),
    people_db = configMap.people_model.get_db(),
    chatee = configMap.chat_model.get_chatee();
    people_db().each( function ( person, idx ) { // eslint-disable-line no-unused-vars
      console.log('olc:', person.name);
      var select_class = '';
    ...
    if ( ! list_html ) {
      ...
      + 'To chat alone is the fate of all great souls...<br>'
      + 'No one is online'
      + '</div>';
      clearChat();
    }
  ...
  onLogin = function ( event, login_user ) {		 // eslint-disable-line no-unused-vars
    configMap.set_chat_anchor( 'opened' );
  };
  onLogout = function ( event, logout_user ) {	 // eslint-disable-line no-unused-vars
